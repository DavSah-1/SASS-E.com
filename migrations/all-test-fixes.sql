-- ============================================================================
-- CONSOLIDATED TEST FIXES MIGRATION
-- Run this entire file in Supabase SQL Editor
-- ============================================================================
-- This migration combines 3 separate fixes:
-- 1. Fix RLS infinite recursion in translate_conversations (7 tests)
-- 2. Add missing columns to tables (18 tests)
-- 3. Create missing tables and relationships (8 tests)
-- Expected result: 33 additional tests will pass (91.7% pass rate)
-- ============================================================================
