...
export function createAdminContext(options: Partial<MockContextOptions> = {}): DbContext {
  return {
    ...
    accessToken: options.accessToken || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbi10ZXN0LTEyMyIsInJvbGUiOiJhZG1pbiJ9.mock-signature",
  };
}
...
export function createUserContext(options: Partial<MockContextOptions> = {}): DbContext {
  ...
  return {
    ...
    accessToken: options.accessToken || `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyLXRlc3QtJHt1c2VySWR9Iiwicm9sZSI6InVzZXIifQ.mock-signature-${userId}`,
  };
}
