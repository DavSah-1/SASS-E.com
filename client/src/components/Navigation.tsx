...
import { Download, Menu, X, Home as HomeIcon, Mic, Lightbulb, GraduationCap, Languages, User, Wallet, Target } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 flex justify-between items-center" style={{paddingTop: '0px', paddingBottom: '0px', height: '65px'}}>
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="hidden md:flex items-center gap-4 lg:gap-6 ml-4 lg:ml-8">
            ...
            <a href="/goals" className="text-slate-300 hover:text-purple-400 transition-colors flex items-center gap-2">
