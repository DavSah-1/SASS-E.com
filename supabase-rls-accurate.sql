...
-- TODO: conversation_messages requires custom RLS logic (join through parent table)
...
-- TODO: experiment_steps requires custom RLS logic (join through parent table)
...
-- TODO: fact_check_results requires custom RLS logic (join through parent table)
...
-- TODO: goal_milestones requires custom RLS logic (join through parent table)

-- goal_progress_history
ALTER TABLE goal_progress_history ENABLE ROW LEVEL SECURITY;
-- TODO: goal_progress_history requires custom RLS logic (join through parent table)
...
-- TODO: math_problems requires custom RLS logic (join through parent table)
...
-- TODO: quiz_results requires custom RLS logic (join through parent table)
...
-- TODO: shared_budget_activity requires custom RLS logic (join through parent table)

-- shared_budget_categories
ALTER TABLE shared_budget_categories ENABLE ROW LEVEL SECURITY;
-- TODO: shared_budget_categories requires custom RLS logic (join through parent table)

-- shared_budget_members
ALTER TABLE shared_budget_members ENABLE ROW LEVEL SECURITY;
-- TODO: shared_budget_members requires custom RLS logic (join through parent table)

-- shared_budget_transactions
ALTER TABLE shared_budget_transactions ENABLE ROW LEVEL SECURITY;
-- TODO: shared_budget_transactions requires custom RLS logic (join through parent table)

-- shared_budgets
ALTER TABLE shared_budgets ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Users can view their own shared_budgets" ON shared_budgets FOR SELECT USING (created_by = auth.uid()::text);
CREATE POLICY "Users can create their own shared_budgets" ON shared_budgets FOR INSERT WITH CHECK (created_by = auth.uid()::text);
CREATE POLICY "Users can update their own shared_budgets" ON shared_budgets FOR UPDATE USING (created_by = auth.uid()::text);
CREATE POLICY "Users can delete their own shared_budgets" ON shared_budgets FOR DELETE USING (created_by = auth.uid()::text);
...
-- TODO: translate_conversation_participants requires custom RLS logic (join through parent table)

-- translate_conversations
ALTER TABLE translate_conversations ENABLE ROW LEVEL SECURITY;
-- TODO: translate_conversations requires custom RLS logic (join through parent table)

-- translate_message_translations
ALTER TABLE translate_message_translations ENABLE ROW LEVEL SECURITY;
-- TODO: translate_message_translations requires custom RLS logic (join through parent table)
...
-- TODO: user_learning_badges requires custom RLS logic (join through parent table)

-- user_learning_progress
ALTER TABLE user_learning_progress ENABLE ROW LEVEL SECURITY;
-- TODO: user_learning_progress requires custom RLS logic (join through parent table)
...
-- TODO: user_quiz_attempts requires custom RLS logic (join through parent table)
...
-- TODO: workouts requires custom RLS logic (join through parent table)
